...
- ❌ Send your files or their contents anywhere.
- ❌ Track your usage, behavior, or activity.
- ❌ Use analytics, telemetry, advertising, or tracking pixels.
- ❌ Use cookies or third-party trackers.
- ❌ Store or transmit your password to any server.
...
- Your password is **never stored** anywhere — there is **no master key and no
  backdoor**. If you forget it, your data cannot be recovered (by you, by
  feris, or by anyone).
- feris operates **no servers** that receive your data.

Because your data never reaches feris, feris cannot view, recover, hand over,
or be compelled to produce data that the Software keeps on your device.

---

## 3. Optional Features You Control

Some features may move data **between your own devices** at your request — for
example, **phone access** to your vault over your **own local network**. When
you use such features:

- The data travels **directly between your devices**, under your control.
- feris does **not** receive, route, intercept, or store any of that data.
- You are responsible for the security of your own network and devices.

These features are **optional** and only operate when you choose to enable
them.
...
If a feature ever connects to the internet (for example, an optional check for
software updates), it does so only to perform that specific function and is not
used to collect personal information. Any external service you reach through
such a feature is governed by **that provider's** own privacy policy, not this
one.
...
practices of the specific version you are running.

---

## 7. Your Rights

Since feris collects no personal data, there is no personal data for feris to
access, correct, export, or delete on your behalf. You remain in **full control
of all data on your own device** and may delete it at any time using your
operating system or the app itself.
...
This Privacy Policy may be updated from time to time. The "Last updated" date at
the top reflects the latest version. The guiding principle will always remain
the same: **feris does not collect your data.**

---

## 10. Contact

Questions about privacy? Reach feris here:
