...
setlocal
REM ===========================================================================
REM  Kawaii Vault - run the app in development mode
REM
REM  HOW TO USE:
REM    Double-click this file from INSIDE the Kawaii Vault folder.
REM
...
if not exist "package.json" (
  echo.
  echo ERROR: package.json not found. Run this .bat from inside the Kawaii Vault folder.
  echo.
  pause
  exit /b
)
...
echo.
echo Launching Kawaii Vault in dev mode...
echo.
